...
num_epochs_ = 5 #Times all images are forward-propagated.
batch_size = 128
image_size = 32
...
save_weights = 1
simulation_name = '43cl._5ite_'#'43cl._1ite_segm'#'std_43cl_10ite_32x32_halveall_fcl256' #To be changed every time architecture or data changes to save the weights. 

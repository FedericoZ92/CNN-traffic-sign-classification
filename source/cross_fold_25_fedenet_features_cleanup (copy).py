...
png_converter = 0 #Set to 1 for image preprocessing and png conversion. To 0 if done before.
num_epochs_ = 7 #Times all images are forward-propagated.
batch_size = 128
image_size = 64
...
save_weights = 1
simulation_name = '43cl._9ite_segm'#'43cl._1ite_segm'#'std_43cl_10ite_32x32_halveall_fcl256' #To be changed every time architecture or data changes to save the weights. 
